  ...
  return (
    <div className='murious_about'>
        ...
        <div className='juit_jyc'>
            ...
            <Link to="/" className='jyc_visit'>Visit<img className='hovarr' src={Arrow}/></Link>
        </div>
        <div className='juit_jyc'>
            ...
            <Link to="/" className='jyc_visit murious_reg'>Register<img className='hovarr' src={Arrow}/></Link>
        </div>
